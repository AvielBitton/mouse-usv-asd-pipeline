...
for file_name in input_files:
  ...
  print("""*****Features: ISI and StartEnFreq*****""")
  ...
  print('''*****Features extracting table*****''')
  ...
  print(f'finished to process file {file_name}')
...
def extract_features(dir):
  ...
  print(f'finished to process file all_data')
